...
fun HomeNavGraph(
    ...
    NavHost(
        ...
        composable(route = HomeScreenRoutes.Home.route) {
            ContentHomeScreen(navController = navController)
        }
...
fun NavGraphBuilder.detailsNavGraph(navController: NavHostController) {
    navigation(
        ...
        composable(
            ...
            arguments = listOf(
                navArgument("food") {
                    type = NavType.ParcelableType(Food::class.java)
                    defaultValue = Food(
                        id = 3,
                        name = "Nescau",
                        description = "com leite",
                        prince = 7.50,
                        size = listOf(Food.Size.SMALL, Food.Size.MEDIUM, Food.Size.LARGE),
...
sealed class DetailsScreenRoutes(val route: String) {
    object ProductScreen : DetailsScreenRoutes(route = "product/{food}")
}
